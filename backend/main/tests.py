...
from main.models import FacultyAdvisor, Society, Board, Committee, Activity, Senate, SenateMembership, SocialLink, Contact
...
class MainModelsTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.committee_1 = Committee.objects.create(name='committee_1', board=cls.board_1, slug='committee_1')
        cls.activity_1 = Activity.objects.create(name='activity_1', society=cls.society_1, committee=cls.committee_1)
        ...
        cls.social_link_1 = SocialLink.objects.create(society=cls.society_1, social_media='YT', link='https://youtube.com')
    ...
    def test_board_str_method(self):
        ...
        self.assertEqual(self.board_1.__str__(), 'board - 2000')

    def test_society_str_method(self):
        """Test Society __str__ method"""
        self.assertEqual(self.society_1.__str__(), 'society_1 - 2000')

    def test_society_year_property(self):
        """Test Society year property"""
        self.assertEqual(self.society_1.year, '2000')

    def test_society_active_property(self):
        """Test Society is_active property"""
        self.assertTrue(self.society_1.is_active)

    def committee_str_method(self):
        """Test Committee __str__ method"""
        self.assertEqual(self.committee_1.__str__(), 'committee_1 - 2000')

    def committee_year_property(self):
        """Test Committee year property"""
        self.assertEqual(self.committee_1.year, '2000')

    def committee_active_property(self):
        """Test Committee is_active property"""
        self.assertTrue(self.committee_1.is_active)

    def test_activity_str_method(self):
        """Test activity __str__ method"""
        self.assertEqual(self.activity_1.__str__(), 'activity_1 - society_1')
    ...
    def test_social_link_str_method_case_1(self):
        ...
        self.assertEqual(self.social_link_1.__str__(), 'society_1 - YouTube')

    def test_social_link_str_method_case_2(self):
        """Test social link __str__ method case: unknown choice"""
        self.assertEqual(self.social_link_2.__str__(), 'society_1 - AB')
...
class MainURLsTestCase(TestCase):
    ...
    def test_main_app_urls_case_5(self):
        """case: board"""
        response = self.client.get(self.board_1.get_absolute_url())
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'main/board.html')
