...
from main.models import Society, Club, Activity, Committee
...
class SocietyNode(DjangoObjectType):
    ...
    class Meta:
        model = Society
        fields = (
            'name', 'slug', 'secretary', 'joint_secretary', 'description', 'mentor', 'club_set', 'committee_set', 'cover', 'report_link',
            'is_active',
            'gallery', 'custom_html')
